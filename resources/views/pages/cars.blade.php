        ...
        <div class="nav-scroller bg-body shadow-sm">
            <div class="container">
                ...
                <a class="nav-link" href="#">
                    ...
                    <a class="nav-link" href="#">سيارت جديدة</a>
                    <a class="nav-link" href="#">سيرات مستعملة</a>
                    <a class="nav-link" href="#">اخر مديل</a>
                    <a class="nav-link" href="#">قطع غير</a>
                    <a class="nav-link" href="#">زيوات</a>
                    <a class="nav-link" href="#">ادوات </a>
                    <a class="nav-link" href="#">مفاتيح</a>
                </nav>
            </div>
        </div>
            ...
            <div class="row ustify-content-sm-center   ">
                @php
                    ...
                    try {
                        ...
                        for ($i = 0; $i <= $all; $i++) {
                            $get_info = "SELECT * FROM `prodect` WHERE typ='cars' AND id=" . $i . ';';
                            $info = $db->prepare($get_info);
                            $info->execute();
                            $informtion = $info->fetchAll();
