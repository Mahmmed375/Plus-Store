        ...
        <div class="nav-scroller bg-body shadow-sm">
            <div class="container">
                ...
                <a class="nav-link" href="#">
                    ...
                    <a class="nav-link" href="#">ملابس خارجة</a>
                    <a class="nav-link" href="#">ملابس داخلية</a>
                    <a class="nav-link" href="#">احزية</a>
                    <a class="nav-link" href="#">عطور</a>
                    <a class="nav-link" href="#">مستحضرات تجميل</a>
                    <a class="nav-link" href="#">اكسسوارات</a>
                    <a class="nav-link" href="#">اخر الصيحات</a>
                </nav>
            </div>
        </div>
            ...
            <div class="row ustify-content-sm-center   ">
                @php
                    ...
                    try {
                        ...
                        for ($i = 0; $i <= $all; $i++) {
                            $get_info = "SELECT * FROM `prodect` WHERE typ='men' AND id=" . $i . ';';
                            $info = $db->prepare($get_info);
                            $info->execute();
                            $informtion = $info->fetchAll();
